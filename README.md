...
This is a specification for the _nrl-consumer-api_ API.
...
Telling Apigee how to connect to your backend requires a _Target Server_, which you should call named `nrl-consumer-api-target`.
